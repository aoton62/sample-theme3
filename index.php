...
<body>
  ...
  <nav id="pickup_field">
    <ul>
      <li class="now">
        <img src="images/pickup1.jpg" alt="「企画展覧会。日本✕写真。開催期間2015年8月28日より東京、大阪、福岡、名古屋、仙台巡回」" id="pickup1" width="840" height="404">
      </li>
      <li>
        <img src="images/pickup2.jpg" alt="全国から集まった写真、約200点展示" id="pickup2" width="840" height="404">
      </li>
      <li>
        <img src="images/pickup3.jpg" alt="壁に風景写真が3点掛けられている" id="pickup3" width="840" height="404">
      </li>
    </ul>
  </nav>
  ...
  <div class="contents">
    <main>
      <section class="topics">
        <h2>トピックス</h2>
        <ul>
          <li><time datetime="2015-09-20">2015年09月20日</time>総入場者数が1万人突破いたしました。</li>
    ...
    <aside>
      <figure>
        <a href="gallery.html">
          <img src="images/btn_gallery.jpg" alt="作品紹介" width="200" height="114">
        </a>
      </figure>

      <figure>
        <a href="tickets.html">
          <img src="images/btn_tickets.jpg" alt="前売り券申し込み"　width="200" height="84">
          <figcaption>前売り券好評販売中</figcaption>
        </a>
      </figure>
    </aside>
  </div>
  ...
  <footer>
    ...
    <address>
      電話<a href="tel:0120XXX001">0120-XXX-001</a>
      FAX<a href="fax:0120XXX002">0120-XXX-002</a>
    </address>
    <small>
